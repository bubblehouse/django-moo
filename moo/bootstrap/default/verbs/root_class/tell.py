...
"""
Send a message from one object to another. The `$root_class` definition of this verb tests to see
...
from moo.sdk import write

if this.is_player() and this.is_connected():
    write(this, "".join(args))
