#!moo verb untie free release unfasten unattach unhook --on $player --dspec either
...
"""Player command for UNTIE: delegate to V-UNTIE."""

_.zork_thing.invoke_verb("v-untie")
