...
if (
    rarg == "M-BEG"
    and the_player_verb == "enter"
    or the_player_verb in ["go", "walk", "move"]
    and parser.get_dobj_str() in ("west", "in")
    or the_player_verb == "through"
    and parser.get_dobj() == lookup("barrow")
):
    print(
    ...
    if (((_.table_get(0, 1)) or 0) & ((8) or 0)) == 0:
        print(
