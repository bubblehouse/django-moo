...
while True:
    ...
    if _.table_get(oo, player.zstate_get("V-VILLAIN")) == parser.get_dobj():
        break
parser.get_dobj().set_flag("hostile", True)
...
if res == player.zstate_get("MISSED") or res == player.zstate_get("HESITATE"):
    ...
    parser.get_dobj().set_flag("staggered", True)
else:
    dweapon.set_flag("obvious", False)
    dweapon.set_flag("weapon", True)
    dweapon.moveto(player.here())
    # ZIL: <THIS-IS-IT ...>
    _.zork_thing.this_is_it(dweapon)
# ZIL: <VILLAIN-RESULT ...>
return _.zork_thing.villain_result(parser.get_dobj(), def_v, res)
