...
state.  Falls back to the System Object when the player has no per-player
value for that key — that's where bootstrap-level constants like the
message tables (YUKS, JUMPLOSS, …) live.
"""
