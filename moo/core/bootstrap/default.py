...
with code.context(wizard, log.info):
    ...
    thing.set_property("take_succeeded_msg", "")
    thing.set_property("otake_failed_msg", "")
    thing.set_property("take_succeeded_msg", "")
    thing.set_property("take_failed_msg", "")
    thing.set_property("odrop_succeeded_msg", "")
    thing.set_property("odrop_failed_msg", "")
    thing.set_property("drop_succeeded_msg", "")
    thing.set_property("drop_failed_msg", "")
