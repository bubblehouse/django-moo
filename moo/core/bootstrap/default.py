...
with code.context(wizard, log.info):
    ...
    exit.set_property("autolock", False, inherited=True)

    exit.set_property("source", None, inherited=True)
    exit.set_property("dest", None, inherited=True)
    exit.set_property("nogo_msg", "You can't go that way.", inherited=True)
    exit.set_property("onogo_msg", "{actor} can't go that way.", inherited=True)
    exit.set_property("arrive_msg", "You arrive at {subject}.", inherited=True)
    exit.set_property("oarrive_msg", "{actor} arrives at {subject}.", inherited=True)
    exit.set_property("oleave_msg", "{actor} leaves {subject}.", inherited=True)
    exit.set_property("leave_msg", "You leave {subject}.", inherited=True)
