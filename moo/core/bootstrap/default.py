...
with code.context(wizard, log.info):
    ...
    exit.set_property("onogo_msg", "%s can't go that way.", inherited=True)
    exit.set_property("arrive_msg", "You arrive at %s.", inherited=True)
    exit.set_property("oarrive_msg", "%s arrives at %s.", inherited=True)
    exit.set_property("oleave_msg", "%s leaves %s.", inherited=True)
    exit.set_property("leave_msg", "You leave %s.", inherited=True)
