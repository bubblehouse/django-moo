    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contents', to='core.object')),
            ],
        ),
        migrations.CreateModel(
            name='Permission',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', termiverse.core.models.URLField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='core.object')),
                ('repo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='core.repository')),
            ],
        ),
        migrations.CreateModel(
            name='VerbName',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('string', 'string'), ('python', 'python'), ('dynamic', 'dynamic')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='core.object')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(choices=[('everyone', 'everyone'), ('owners', 'owners'), ('wizards', 'wizards')], max_length=8, null=True)),
                ('weight', models.IntegerField(default=0)),
                ('accessor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rights', to='core.object')),
                ('object', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='acl', to='core.object')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usage', to='core.permission')),
                ('property', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='acl', to='core.property')),
                ('verb', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='acl', to='core.verb')),
            ],
            options={
