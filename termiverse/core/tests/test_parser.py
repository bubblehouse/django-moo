...
def test_parse_imperative_command(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_direct_object(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_object_of_the_preposition(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_object_of_the_preposition_with_preposition(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_direct_object_object_of_the_preposition_with_preposition(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_direct_object_and_multiple_prepositions_with_specifiers(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_command_referring_to_aliases(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_with_quoted_strings(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
    lex = parse.Lexer("@eval wizard to 'something here'")
    parser = parse.Parser(lex, t_wizard)
    assert parser.get_pobj_str('to') == 'something here'

@pytest.mark.django_db
def test_parse_with_quoted_strings_and_escapes(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
...
@pytest.mark.django_db
def test_parse_with_my_object(t_init: Object, t_wizard: Object):  # pylint: disable=redefined-outer-name
